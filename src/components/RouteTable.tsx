            ...
            <tr key={`${r.commodityId}-${r.originTerminalId}-${r.destTerminalId}-${i}`}
              ...
              <td className="py-2 px-2">
                ...
                <div className="text-[10px] text-muted-foreground">
                  {getLocationZh(r.originSystemName)}
                  {r.originStock > 0 && <span className="ml-1">库存{r.originStock.toLocaleString()}</span>}
                </div>
              ...
              <td className="py-2 px-2">
                ...
                <div className="text-[10px] text-muted-foreground">
                  {getLocationZh(r.destSystemName)}
                  {r.destStock > 0 && <span className="ml-1">库存{r.destStock.toLocaleString()}</span>}
                </div>
